...
class MasterNode : public rclcpp::Node
{
  ...
  private:
    ...
    rclccp::Subscriber<ackermann_msgs::msg::AckermannDriveStamped>::SharedPtr _disparityDriveSubscriber;
    rlccpp::Subscriber<arcus_msgs::msg::AckermannDriveStamped>::SharedPtr _safetyDriveSubscriber;
    rclcpp::Subscriber<arcus_msgs::msg::AckermannDriveStamped>::SharedPtr _purePursuitDriveSubscriber;
    rclcpp::Subscriber<arcus_msgs::msg::AckermannDriveStamped>::SharedPtr _controllerDriveSubscriber;
};